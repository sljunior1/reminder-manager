...
public partial class NotRegisteredView : ContentPageBase
{
    private readonly NotRegisteredViewModel _viewModel;
    private readonly ISettingsService _settingsService;
    private bool _isPasswordVisible = false;
    private bool _isPasswordConfirmVisible = false;
    public NotRegisteredView(NotRegisteredViewModel viewModel, ISettingsService settingsService)
    {
